...
# гема REXML. 
# На этот раз воспользуемся тем, что метод open возвращает значение,
# которое будет использовано в блоке,
# и присвоим переменной doc то, что будет вычисленно в блоке.
