...
describe Sklonjator do
  it 'returns KROKODILOV' do
    expect(
      Sklonjator.sklonenie(0, 'krokodil', 'krokodila', 'krokodilov', true)
    ).to eq '0 krokodilov'
    ...
    expect(
      Sklonjator.sklonenie(6, 'krokodil', 'krokodila', 'krokodilov', true)
    ).to eq '6 krokodilov'
  end
  ...
  it 'returns KROKODILOV (automated)' do
    [5, 6, 7, 8, 9, 0].each do |number|
      (0..100).step(10) do |i|
        ...
        expect(
#          summa.to_s + ' ' +
          Sklonjator.sklonenie(summa, 'krokodil', 'krokodila', 'krokodilov', true)
  ...
  it 'returns KROKODIL' do
    [1, 21, 31, 141].each do |number|
      expect(
 #       number.to_s + ' ' +
        Sklonjator.sklonenie(number, 'krokodil', 'krokodila', 'krokodilov', true)
